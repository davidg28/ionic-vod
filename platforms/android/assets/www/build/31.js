...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LancamentosFilmesPageModule", function() { return LancamentosFilmesPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lancamentos_filmes__ = __webpack_require__(421);
...
var LancamentosFilmesPageModule = /** @class */ (function () {
    function LancamentosFilmesPageModule() {
    }
    LancamentosFilmesPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__lancamentos_filmes__["a" /* LancamentosFilmesPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__lancamentos_filmes__["a" /* LancamentosFilmesPage */]),
            ],
        })
    ], LancamentosFilmesPageModule);
    return LancamentosFilmesPageModule;
}());

//# sourceMappingURL=lancamentos-filmes.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LancamentosFilmesPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(40);
...
var LancamentosFilmesPage = /** @class */ (function () {
    function LancamentosFilmesPage(navCtrl, ApiProvider, loadingCtrl) {
    ...
    LancamentosFilmesPage.prototype.verificarstatus = function () {
        var _this = this;
    ...
    LancamentosFilmesPage.prototype.openPage = function (page) {
        this.navCtrl.setRoot(page.component);
    };
    LancamentosFilmesPage.prototype.onKey = function (event, nextElement) {
        if (event.key === "Enter") {
            this.varFilme(nextElement);
        }
    };
    LancamentosFilmesPage.prototype.onKeyMENU = function (event, nextElement) {
        if (event.key === "Enter") {
            this.openPage(nextElement);
        }
    };
    LancamentosFilmesPage.prototype.onKeyVERMAIS = function (event) {
        if (event.key === "Enter") {
            this.doInfinite(1);
        }
    };
    LancamentosFilmesPage.prototype.AbreCarregando = function () {
        this.loader = this.loadingCtrl.create({
            content: "Carregando filmes..."
        });
        this.loader.present();
    };
    LancamentosFilmesPage.prototype.FechaCarregando = function () {
        this.loader.dismiss();
    };
    LancamentosFilmesPage.prototype.varFilme = function (n) {
        this.navCtrl.push('DetalheFilmePage', { id: n });
    };
    LancamentosFilmesPage.prototype.carregarFeed = function () {
        var _this = this;
        this.AbreCarregando();
    ...
    LancamentosFilmesPage.prototype.chamarlista = function (newpage) {
        var _this = this;
