...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Renovar2PageModule", function() { return Renovar2PageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__renovar2__ = __webpack_require__(431);
...
var Renovar2PageModule = /** @class */ (function () {
    function Renovar2PageModule() {
    }
    Renovar2PageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__renovar2__["a" /* Renovar2Page */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__renovar2__["a" /* Renovar2Page */]),
            ],
        })
    ], Renovar2PageModule);
    return Renovar2PageModule;
}());

//# sourceMappingURL=renovar2.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Renovar2Page; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__home_home__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(40);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__categorias_categorias__ = __webpack_require__(340);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__conta_vencida_conta_vencida__ = __webpack_require__(364);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__login_login__ = __webpack_require__(198);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__providers_api_api__ = __webpack_require__(41);
...
var Renovar2Page = /** @class */ (function () {
    function Renovar2Page(navCtrl, navController, ApiProvider, loadingCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navController = navController;
        this.ApiProvider = ApiProvider;
        this.loadingCtrl = loadingCtrl;
        ...
        this.menu = [
            ...
            { icon: "ios-card", title: 'Assinatura', component: __WEBPACK_IMPORTED_MODULE_17__conta_vencida_conta_vencida__["a" /* ContaVencidaPage */] },
            { icon: "ios-exit-outline", title: 'Sair', component: __WEBPACK_IMPORTED_MODULE_18__login_login__["a" /* LoginPage */] },
        ];
        this.verificarstatus();
    }
    Renovar2Page.prototype.verificarstatus = function () {
        var _this = this;
        var LGD = localStorage.getItem('LOGADO');
        var USR = localStorage.getItem('USUARIO');
        var DTBS;
        this.ApiProvider.verStatus(USR).subscribe(function (data) {
            ...
            if (DTBS.STATUS == "1") {
                ...
                _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_18__login_login__["a" /* LoginPage */]);
            }
        }, function (error) {
            console.log(error);
        });
    };
    Renovar2Page.prototype.onKey = function (event) {
        if (event.key === "Enter") {
            this.enviar();
        }
    };
    Renovar2Page.prototype.AbreCarregando = function () {
        this.loader = this.loadingCtrl.create({
            content: "Carregando..."
        });
        this.loader.present();
    };
    Renovar2Page.prototype.FechaCarregando = function () {
        this.loader.dismiss();
    };
    Renovar2Page.prototype.ionViewDidEnter = function () {
        var _this = this;
        setTimeout(function () {
            _this.sInput.setFocus();
        }, 500);
    };
    Renovar2Page.prototype.enviar = function () {
        var _this = this;
        this.AbreCarregando();
        this.ApiProvider.renovar2(this.TITULO, this.USER).subscribe(function (data) {
            var response = data;
            var objeto_retorno = JSON.parse(response._body);
            _this.lista = objeto_retorno.DADOS;
            if (_this.lista.STATUS == '1') {
                __WEBPACK_IMPORTED_MODULE_20_sweetalert___default()("Renovado com sucesso!", "", "success").then(function (value) {
                    _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_0__home_home__["a" /* HomePage */]);
                });
            }
            else {
                __WEBPACK_IMPORTED_MODULE_20_sweetalert___default()("Código inválido", "", "error").then(function (value) {
                });
            }
            _this.FechaCarregando();
        }, function (error) {
    ...
    Renovar2Page.prototype.onKeyMENU = function (event, nextElement) {
        if (event.key === "Enter") {
            this.openPage(nextElement);
        }
    };
    Renovar2Page.prototype.openPage = function (page) {
        // Reset the content nav to have just this page
        // we wouldn't want the back button to show in this scenario
        this.navCtrl.setRoot(page.component);
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["_8" /* ViewChild */])('searchInput'),
        __metadata("design:type", Object)
    ], Renovar2Page.prototype, "sInput", void 0);
    Renovar2Page = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["m" /* Component */])({
            selector: 'page-renovar2',template:/*ion-inline-start:"D:\Work\Sources\plextv2-master-novo-master\src\pages\renovar2\renovar2.html"*/'\n<ion-content padding class="background-body">\n\n\n    <ion-grid>\n        <ion-row>\n\n\n\n\n\n                  <ion-col col-12 col-md-12 col-lg-12 col-xl-12 class="div-ion">\n                    <h2 style="color: #fff">Digite o código para renovar sua assinatura </h2>\n\n                    <ion-item class="ion-item" >\n\n                        <ion-input type="text"   #searchInput m placeholder="Digite aqui" class="ion-input3" [(ngModel)]="TITULO" style="color: #fff !important;" (keyup)="onKey($event, \'1\')"></ion-input>\n\n                      </ion-item>\n                      <button ion-button class="btn-avancar botao-play botao-detalhe" (keyup)="onKey($event, \'1\')" (click)="enviar()"  style="width: 100%;" >RENOVAR</button>\n\n\n                </ion-col>\n\n\n\n\n      </ion-row>\n      </ion-grid>\n\n\n\n  </ion-content>\n'/*ion-inline-end:"D:\Work\Sources\plextv2-master-novo-master\src\pages\renovar2\renovar2.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["h" /* NavController */],
...
//# sourceMappingURL=renovar2.js.map
