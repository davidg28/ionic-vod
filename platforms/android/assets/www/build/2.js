...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QuatrokseriesPageModule", function() { return QuatrokseriesPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__quatrokseries__ = __webpack_require__(429);
...
var QuatrokseriesPageModule = /** @class */ (function () {
    function QuatrokseriesPageModule() {
    }
    QuatrokseriesPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__quatrokseries__["a" /* QuatrokseriesPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__quatrokseries__["a" /* QuatrokseriesPage */]),
            ],
        })
    ], QuatrokseriesPageModule);
    return QuatrokseriesPageModule;
}());

//# sourceMappingURL=quatrokseries.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__buscar_series_buscar_series__ = __webpack_require__(335);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__buscar_filmes_buscar_filmes__ = __webpack_require__(334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__categoria_serie_categoria_serie__ = __webpack_require__(336);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__home_serie_home_serie__ = __webpack_require__(333);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__categoria_categoria__ = __webpack_require__(337);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return QuatrokseriesPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__home_home__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__home_filme_home_filme__ = __webpack_require__(344);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__home_serie_home_serie__ = __webpack_require__(333);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__categorias_categorias__ = __webpack_require__(340);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pesquisar_pesquisar__ = __webpack_require__(350);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__adulto_adulto__ = __webpack_require__(339);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pedir_pedir__ = __webpack_require__(349);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__opcao_opcao__ = __webpack_require__(348);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__menu_menu__ = __webpack_require__(332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__ver_serie_ver_serie__ = __webpack_require__(410);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__providers_api_api__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__quatrok_quatrok__ = __webpack_require__(352);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__qrcode_qrcode__ = __webpack_require__(351);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20_sweetalert__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20_sweetalert___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_20_sweetalert__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__login_login__ = __webpack_require__(198);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var QuatrokseriesPage = /** @class */ (function () {
    function QuatrokseriesPage(navCtrl, navParams, ApiProvider, loadingCtrl, navController) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.ApiProvider = ApiProvider;
        this.loadingCtrl = loadingCtrl;
        ...
        this.pages = [
            ...
            { icon: "ios-easel-outline", title: '4k', component: __WEBPACK_IMPORTED_MODULE_18__quatrok_quatrok__["a" /* QuatrokPage */] },
            { icon: "ios-film", title: 'Todos os Filmes', component: __WEBPACK_IMPORTED_MODULE_8__home_filme_home_filme__["a" /* HomeFilmePage */] },
            { icon: "ios-desktop-outline", title: 'Todas as Séries', component: __WEBPACK_IMPORTED_MODULE_9__home_serie_home_serie__["a" /* HomeSeriePage */] },
            { icon: "ios-folder-open", title: 'Categorias', component: __WEBPACK_IMPORTED_MODULE_10__categorias_categorias__["a" /* CategoriasPage */] },
            { icon: "ios-search", title: 'Pesquisar', component: __WEBPACK_IMPORTED_MODULE_11__pesquisar_pesquisar__["a" /* PesquisarPage */] },
            { icon: "ios-lock", title: 'XXX', component: __WEBPACK_IMPORTED_MODULE_12__adulto_adulto__["a" /* AdultoPage */] },
            { icon: "ios-send", title: 'Pedir Filme e Séries', component: __WEBPACK_IMPORTED_MODULE_13__pedir_pedir__["a" /* PedirPage */] },
            { icon: "ios-phone-portrait-outline", title: 'Instale no celular', component: __WEBPACK_IMPORTED_MODULE_19__qrcode_qrcode__["a" /* QrcodePage */] },
            { icon: "ios-settings", title: 'Configurações', component: __WEBPACK_IMPORTED_MODULE_14__opcao_opcao__["a" /* OpcaoPage */] },
        ];
        this.verificarstatus();
    }
    QuatrokseriesPage.prototype.verificarstatus = function () {
        var _this = this;
        var LGD = localStorage.getItem('LOGADO');
        var USR = localStorage.getItem('USUARIO');
        var DTBS;
        this.ApiProvider.verStatus(USR).subscribe(function (data) {
            ...
            if (DTBS.STATUS == "1") {
                ...
                __WEBPACK_IMPORTED_MODULE_20_sweetalert___default()("Seu login foi desativado!", "Entre em contato com o administrador para saber o porque.", "error");
                _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_21__login_login__["a" /* LoginPage */]);
            }
        }, function (error) {
            console.log(error);
        });
    };
    QuatrokseriesPage.prototype.onKey = function (event, nextElement) {
        if (event.key === "Enter") {
            this.varFilme(nextElement);
        }
    };
    QuatrokseriesPage.prototype.onKeyMENU = function (event, nextElement) {
        if (event.key === "Enter") {
            this.openPage(nextElement);
        }
    };
    QuatrokseriesPage.prototype.onKeyVERMAIS = function (event) {
        if (event.key === "Enter") {
            this.doInfinite(1);
        }
    };
    QuatrokseriesPage.prototype.voltar = function () {
        this.navController.pop();
    };
    QuatrokseriesPage.prototype.openPage = function (page) {
        // Reset the content nav to have just this page
        // we wouldn't want the back button to show in this scenario
        this.navCtrl.setRoot(page.component);
    };
    QuatrokseriesPage.prototype.menu = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_15__menu_menu__["a" /* MenuPage */]);
    };
    QuatrokseriesPage.prototype.AbreCarregando = function () {
        this.loader = this.loadingCtrl.create({
            content: "Carregando..."
        });
        this.loader.present();
    };
    QuatrokseriesPage.prototype.FechaCarregando = function () {
        this.loader.dismiss();
    };
    QuatrokseriesPage.prototype.varFilme = function (n) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_16__ver_serie_ver_serie__["a" /* VerSeriePage */], { id: n });
    };
    QuatrokseriesPage.prototype.carregarFeed = function () {
        var _this = this;
        var id = "34";
        this.AbreCarregando();
        this.ApiProvider.CatSeries(id).subscribe(function (data) {
            var response = data;
            var objeto_retorno = JSON.parse(response._body);
            _this.lista = objeto_retorno.DADOS;
            _this.STATUS = _this.lista[0].STATS;
            _this.FechaCarregando();
        }, function (error) {
            console.log(error);
            _this.FechaCarregando();
    ...
    QuatrokseriesPage.prototype.chamarlista = function (newpage) {
        var _this = this;
        if (newpage === void 0) { newpage = false; }
        var id = "34";
        this.AbreCarregando();
        this.ApiProvider.CatSeries(id, this.page).subscribe(function (data) {
            var response = data;
            var objeto_retorno = JSON.parse(response._body);
            if (newpage) {
                _this.lista = _this.lista.concat(objeto_retorno.DADOS);
    ...
    QuatrokseriesPage.prototype.doRefresh = function (refresher) {
        this.refresher = refresher;
        this.isRefreshing = true;
        this.chamarlista();
    };
    QuatrokseriesPage.prototype.doInfinite = function (infiniteScroll) {
        this.page++;
        this.infiniteScroll = infiniteScroll;
        this.chamarlista(true);
    };
    QuatrokseriesPage.prototype.ionViewDidEnter = function () {
        this.chamarlista();
    };
    QuatrokseriesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-quatrokseries',template:/*ion-inline-start:"D:\Work\Sources\plextv2-master-novo-master\src\pages\quatrokseries\quatrokseries.html"*/'\n<ion-content padding class="background-body4k">\n  <button ion-button  menuToggle class="menu">\n      <ion-icon name="menu" style="color: #fff" ></ion-icon>\n    </button>\n\n<ion-grid >\n        <ion-row>\n\n          <ion-col col-2 class="esconder-menu" >\n              <ion-list style="border-color: transparent !important;">\n                  <button menuClose ion-item no-lines *ngFor="let p of pages" (keyup)="onKeyMENU($event,p)" (click)="openPage(p)" style="background-color: transparent; color: #fff; font-size: 15px; "  class="botao-menu texto-menu">\n                    <ion-icon name="{{p.icon}}" style="font-size: 90px"></ion-icon>\n                    <br>\n\n                  {{p.title}}\n\n                  </button>\n\n                </ion-list>\n            </ion-col>\n\n      <ion-col col-12 col-md-10 col-lg-10 col-xl-10  style="height: 100px">\n\n\n            <ion-row >\n\n          <ion-col col-lg-2 col-sm-3 col-6 *ngFor="let l of lista" >\n     <div *ngIf="l.STATUS == 1">\n        <div class="estrela-capa"><ion-icon name="ios-star"></ion-icon> {{l.RATING}} </div>\n             <button ion-button  style="box-shadow: 1px 2px 20px #000; background-color: transparent;  padding: 0px; " class="caixa-capa" (keyup)="onKey($event,l.ID_SERIE)" (click)="varFilme(l.ID_SERIE)" >\n              <img class="img2-capa" [src]="l.CAPA" width="100%"  height="100%">\n              <span class="fundo-capa"></span>\n              <p class="titulo-filmes"><b >{{l.TITULO}}</b></p>\n            </button>\n      </div>\n          </ion-col>\n\n      </ion-row>\n\n\n      <button (keyup)="onKeyVERMAIS($event)"   class="botao-ver-mais" ion-button style="width: 100%; background-color: transparent; " (click)="doInfinite(1)">VER MAIS</button>\n      <br><br>\n\n      <h1  *ngIf="this.STATUS == 0" style="text-align: center">\n          <br><br>\n          Nenhuma série encontrada nesta categoria\n        </h1>\n\n\n\n\n          </ion-col>\n\n\n\n\n\n        </ion-row>\n\n\n\n      </ion-grid>\n\n\n\n</ion-content>\n'/*ion-inline-end:"D:\Work\Sources\plextv2-master-novo-master\src\pages\quatrokseries\quatrokseries.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
    ...
    return QuatrokseriesPage;
}());

//# sourceMappingURL=quatrokseries.js.map
