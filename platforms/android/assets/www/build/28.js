...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LegendadosFilmesPageModule", function() { return LegendadosFilmesPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__legendados_filmes__ = __webpack_require__(423);
...
var LegendadosFilmesPageModule = /** @class */ (function () {
    function LegendadosFilmesPageModule() {
    }
    LegendadosFilmesPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__legendados_filmes__["a" /* LegendadosFilmesPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__legendados_filmes__["a" /* LegendadosFilmesPage */]),
            ],
        })
    ], LegendadosFilmesPageModule);
    return LegendadosFilmesPageModule;
}());

//# sourceMappingURL=legendados-filmes.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LegendadosFilmesPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(40);
...
var LegendadosFilmesPage = /** @class */ (function () {
    function LegendadosFilmesPage(navCtrl, navController, ApiProvider, loadingCtrl, navParams) {
    ...
    LegendadosFilmesPage.prototype.verificarstatus = function () {
        var _this = this;
    ...
    LegendadosFilmesPage.prototype.openPage = function (page) {
        // Reset the content nav to have just this page
        // we wouldn't want the back button to show in this scenario
        this.navCtrl.setRoot(page.component);
    };
    LegendadosFilmesPage.prototype.onKey = function (event, nextElement) {
        if (event.key === "Enter") {
            this.varFilme(nextElement);
        }
    };
    LegendadosFilmesPage.prototype.onKeyMENU = function (event, nextElement) {
        if (event.key === "Enter") {
            this.openPage(nextElement);
        }
    };
    LegendadosFilmesPage.prototype.onKeyVERMAIS = function (event) {
        if (event.key === "Enter") {
            this.doInfinite(1);
        }
    };
    LegendadosFilmesPage.prototype.voltar = function () {
        this.navController.pop();
    };
    LegendadosFilmesPage.prototype.AbreCarregando = function () {
        this.loader = this.loadingCtrl.create({
            content: "Carregando..."
        });
        this.loader.present();
    };
    LegendadosFilmesPage.prototype.FechaCarregando = function () {
        this.loader.dismiss();
    };
    LegendadosFilmesPage.prototype.varFilme = function (n) {
        this.navCtrl.push('DetalheFilmePage', { id: n });
    };
    LegendadosFilmesPage.prototype.carregarFeed = function () {
        var _this = this;
        this.AbreCarregando();
        var id = "29";
    ...
    LegendadosFilmesPage.prototype.chamarlista = function (newpage) {
        var _this = this;
    ...
    return LegendadosFilmesPage;
}());

//# sourceMappingURL=legendados-filmes.js.map
