...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SerieCatPageModule", function() { return SerieCatPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__serie_cat__ = __webpack_require__(432);
...
var SerieCatPageModule = /** @class */ (function () {
    function SerieCatPageModule() {
    }
    SerieCatPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__serie_cat__["a" /* SerieCatPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__serie_cat__["a" /* SerieCatPage */]),
            ],
        })
    ], SerieCatPageModule);
    return SerieCatPageModule;
}());

//# sourceMappingURL=serie-cat.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SerieCatPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_api_api__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__menu_menu__ = __webpack_require__(332);
...
var SerieCatPage = /** @class */ (function () {
    function SerieCatPage(navCtrl, navParams, ApiProvider, loadingCtrl, navController) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.ApiProvider = ApiProvider;
        this.loadingCtrl = loadingCtrl;
    ...
    SerieCatPage.prototype.onKey = function (event, nextElement) {
        if (event.key === "Enter") {
            this.varFilme(nextElement);
        }
    };
    SerieCatPage.prototype.onKeyMENU = function (event, nextElement) {
        if (event.key === "Enter") {
            this.openPage(nextElement);
        }
    };
    SerieCatPage.prototype.onKeyVERMAIS = function (event) {
        if (event.key === "Enter") {
            this.doInfinite(1);
        }
    };
    SerieCatPage.prototype.voltar = function () {
        this.navController.pop();
    };
    SerieCatPage.prototype.openPage = function (page) {
        // Reset the content nav to have just this page
        // we wouldn't want the back button to show in this scenario
        this.navCtrl.setRoot(page.component);
    };
    SerieCatPage.prototype.menu = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__menu_menu__["a" /* MenuPage */]);
    };
    SerieCatPage.prototype.AbreCarregando = function () {
        this.loader = this.loadingCtrl.create({
            content: "Carregando..."
        });
        this.loader.present();
    };
    SerieCatPage.prototype.FechaCarregando = function () {
        this.loader.dismiss();
    };
    SerieCatPage.prototype.varFilme = function (n) {
        this.navCtrl.push('VerSeriePage', { id: n });
    };
    SerieCatPage.prototype.carregarFeed = function () {
        var _this = this;
    ...
    SerieCatPage.prototype.chamarlista = function (newpage) {
        var _this = this;
        if (newpage === void 0) { newpage = false; }
        var id = this.navParams.get("id");
        this.AbreCarregando();
    ...
    SerieCatPage.prototype.doRefresh = function (refresher) {
        this.refresher = refresher;
        this.isRefreshing = true;
        this.chamarlista();
    };
    SerieCatPage.prototype.doInfinite = function (infiniteScroll) {
        this.page++;
        this.infiniteScroll = infiniteScroll;
        this.chamarlista(true);
    };
    SerieCatPage.prototype.ionViewDidEnter = function () {
        this.chamarlista();
    };
    SerieCatPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-serie-cat',template:/*ion-inline-start:"D:\Work\Sources\plextv2-master-novo-master\src\pages\serie-cat\serie-cat.html"*/'\n<ion-content padding class="background-body">\n\n\n  <ion-grid >\n          <ion-row>\n\n            <ion-col col-2  class="esconder-menu">\n                <ion-list style="border-color: transparent !important;">\n\n\n\n\n                  <button id="menu" menuClose ion-item no-lines *ngFor="let p of pages" (keyup)="onKeyMENU($event,p)" (click)="openPage(p)" autofocus  style="background-color: transparent; color: #fff; font-size: 15px;"  class="botao-menu texto-menu">\n                    <ion-icon name="{{p.icon}}" style="font-size: 90px; padding: 0px !important"></ion-icon>\n                    <br>\n\n                  {{p.title}}\n                    </button>\n\n                  </ion-list>\n              </ion-col>\n\n        <ion-col col-12 col-md-10 col-lg-10 col-xl-10  style="height: 100px">\n            <ion-buttons left>\n                <button ion-button icon-only class="voltar" (click)="voltar()" style="background-color: transparent">\n                    <ion-icon name="arrow-back"></ion-icon>  voltar &nbsp;&nbsp;\n                </button>\n              </ion-buttons>\n\n\n              <ion-row >\n\n            <ion-col col-lg-2 col-sm-3 col-4 *ngFor="let l of lista" >\n       <div *ngIf="l.STATUS == 1">\n          <div class="estrela-capa"><ion-icon name="ios-star"></ion-icon> {{l.RATING}} </div>\n               <button ion-button  style="box-shadow: 1px 2px 20px #000; background-color: transparent;  padding: 0px; " class="caixa-capa" (keyup)="onKey($event,l.ID_SERIE)"  (click)="varFilme(l.ID_SERIE)" >\n                <img class="img2-capa" [src]="l.CAPA" width="100%"  height="100%">\n                <span class="fundo-capa"></span>\n                <p class="titulo-filmes"><b >{{l.TITULO}}</b></p>\n              </button>\n        </div>\n            </ion-col>\n\n        </ion-row>\n\n\n        <button (keyup)="onKeyVERMAIS($event)" (click)="doInfinite(1)"   class="botao-ver-mais" ion-button style="width: 100%; background-color: transparent; ">VER MAIS</button>\n        <br><br>\n\n        <h1  *ngIf="this.STATUS == 0" style="text-align: center">\n            <br><br>\n            Nenhuma série encontrada nesta categoria\n          </h1>\n\n\n\n\n            </ion-col>\n\n\n\n\n\n          </ion-row>\n\n\n\n        </ion-grid>\n\n\n\n</ion-content>\n'/*ion-inline-end:"D:\Work\Sources\plextv2-master-novo-master\src\pages\serie-cat\serie-cat.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
...
//# sourceMappingURL=serie-cat.js.map
