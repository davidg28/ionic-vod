...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "KidsfilmePageModule", function() { return KidsfilmePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__kidsfilme__ = __webpack_require__(418);
...
var KidsfilmePageModule = /** @class */ (function () {
    function KidsfilmePageModule() {
    }
    KidsfilmePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__kidsfilme__["a" /* KidsfilmePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__kidsfilme__["a" /* KidsfilmePage */]),
            ],
        })
    ], KidsfilmePageModule);
    return KidsfilmePageModule;
}());

//# sourceMappingURL=kidsfilme.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return KidsfilmePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(40);
...
var KidsfilmePage = /** @class */ (function () {
    function KidsfilmePage(navCtrl, navController, ApiProvider, loadingCtrl, navParams) {
    ...
    KidsfilmePage.prototype.verificarstatus = function () {
        var _this = this;
    ...
    KidsfilmePage.prototype.openPage = function (page) {
        // Reset the content nav to have just this page
        // we wouldn't want the back button to show in this scenario
        this.navCtrl.setRoot(page.component);
    };
    KidsfilmePage.prototype.onKey = function (event, nextElement) {
        if (event.key === "Enter") {
            this.varFilme(nextElement);
        }
    };
    KidsfilmePage.prototype.onKeyMENU = function (event, nextElement) {
        if (event.key === "Enter") {
            this.openPage(nextElement);
        }
    };
    KidsfilmePage.prototype.onKeyVERMAIS = function (event) {
        if (event.key === "Enter") {
            this.doInfinite(1);
        }
    };
    KidsfilmePage.prototype.voltar = function () {
        this.navController.pop();
    };
    KidsfilmePage.prototype.AbreCarregando = function () {
        this.loader = this.loadingCtrl.create({
            content: "Carregando..."
        });
        this.loader.present();
    };
    KidsfilmePage.prototype.FechaCarregando = function () {
        this.loader.dismiss();
    };
    KidsfilmePage.prototype.varFilme = function (n) {
        this.navCtrl.push('DetalheFilmePage', { id: n });
    };
    KidsfilmePage.prototype.carregarFeed = function () {
        var _this = this;
        this.AbreCarregando();
        var id = "17";
    ...
    KidsfilmePage.prototype.chamarlista = function (newpage) {
        var _this = this;
    ...
    return KidsfilmePage;
}());

//# sourceMappingURL=kidsfilme.js.map
